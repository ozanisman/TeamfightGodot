...
Applied via balance_version string in MatchReplayInput. Patch applies if archetype_id in targets OR role in roles. Stat modifications override base champion stats. Kit swaps replace entire ability/ultimate/passive definitions.
