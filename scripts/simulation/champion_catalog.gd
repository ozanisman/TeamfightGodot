...
const CHAMPION_DATA := {
	...
	&"colossus": {
		...
		"ability_desc": "Deals 165% damage and taunts all targets in a 1 unit radius for 2.5s.",
		"ultimate_desc": "Colossal impact for 460% damage and a 5.2s stun.",
		"passive_desc": "Reduces all incoming damage by 32%.",
		"ability": {
			"kind": &"multi",
			"params": {
				"effects": [
					{"kind": &"self_aoe_taunt", "params": {"radius": 1.0, "duration": 2.5, "reason": "Seismic Slam"}},
	...
	&"warlock": {
		...
		"passive_desc": "Heals for 1 HP after each auto-attack.",
