...
const CHAMPION_DATA := {
	...
	&"berserker": {
		...
		"passive_desc": "Has innate 15% lifesteal and permanent gains +5% lifesteal per takedown.",
	...
	&"wraith": {
		...
		"ability_desc": "Magic strike for 150% damage. [MAKE MORE INTERESTING]",
	...
	&"mistcaller": {
		...
		"passive_desc": "Every 5s, heals all allies in a 2.0 tile radius for 7% of their missing health over 5s.",
