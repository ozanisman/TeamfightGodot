...
func _create_draft_shell(screen_size: Vector2) -> void:
	...
	_draft_shell.apply_layout(screen_size, true)
	...
	_recommendation_panel = _draft_shell.recommendation_panel
	_recommendation_title = _draft_shell.recommendation_title
	_recommendation_list = _draft_shell.recommendation_list
