...
void add_shield(SimWorld &world, UnitState &source, UnitState &target, double amount, const StringName &action_kind, const ViewerHooks *viewer = nullptr, SimHostCallbacks *host = nullptr);
double heal_unit(SimWorld &world, UnitState &source, UnitState &target, double amount, const StringName &action_kind, bool allow_overheal = false, const ViewerHooks *viewer = nullptr, SimHostCallbacks *host = nullptr);
