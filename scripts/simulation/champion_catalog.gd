...
const CHAMPION_DATA := {
	...
	&"colossus": {
		...
		"ability_desc": "Taunts all targets in a 2.5 tile radius for 2.5s and deals 130% damage in a 1.0 tile radius.",
		"ultimate_desc": "Colossal impact in a 2.5 tile radius for 250% damage and a 2.0s stun.",
	...
	&"wraith": {
		...
		"ability_desc": "Magic strike for 150% damage and a 1.0s disarm.",
		"ultimate_desc": "Magic strike for 250% magic damage and 1.5s stun. [MAKE MORE INTERESTING]",
	...
	&"cleric": {
		...
		"ability_desc": "Heals an ally for 20 Health.",
	...
	&"valkyrie": {
		...
		"passive_desc": "Auto attacks deal an additional 10 physical damage in a 0.75 tile radius and heal for 100% of the damage dealt.",
	...
	&"mistcaller": {
		...
		"passive_desc": "All of Mistcaller's excess healing is converted to temporary maximum health. Every 5s, heals all allies in a 3.0 tile radius for 5 + 5% missing health over 3s.",
...
const MINION_DATA := {
	&"skeleton": {
		...
		"ability_desc": "",
		"ultimate_desc": "",
		"passive_desc": "Takes 5 damage every second.",
