...
func predict_draft_winner(team1: Array, team2: Array, stats_dir: String = "res://stats_output", base_weight: float = 0.50, synergy_weight: float = 0.25, counter_weight: float = 0.25, matchup_weight: float = 0.25, composition_weight: float = 0.0, logistic_k: float = 10.0, include_breakdown: bool = false, synergy_amplification: float = 1.2, matchup_amplification: float = 1.2, logit_sharpness: float = 1.5, score_sharpness: float = 1.0, interaction_weight: float = 0.0, scoring_mode: int = 2, variance_weight: float = 0.0, cc_weight: float = 0.0, mobility_weight: float = 0.0, sustain_weight: float = 0.0, best_counter_weight: float = 0.0, worst_counter_weight: float = 0.0, best_synergy_weight: float = 0.0, worst_synergy_weight: float = 0.0, synergy_aggregation: int = 0, counter_aggregation: int = 0, use_decorrelated_scoring: bool = false, draft_position: int = 0, early_pick_base_weight: float = 0.7, late_pick_counter_weight: float = 0.4) -> Dictionary:
	if not _ensure_native_backend():
		push_error("Simulation backend is not available.")
