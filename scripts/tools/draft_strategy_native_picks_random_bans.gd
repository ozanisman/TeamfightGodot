## Native picks + random bans wrapper strategy
...
func get_strategy_name() -> String:
	return "native_picks_random_bans"


func recommend_next_pick(allies: Array, enemies: Array, available: Array, draft_step: int = -1) -> StringName:
	return _native_strategy.recommend_next_pick(allies, enemies, available, draft_step)
...
func recommend_next_ban(allies: Array, enemies: Array, available: Array, draft_step: int = -1, side: String = "blue", weight_overrides: Dictionary = {}) -> StringName:
	return _random_strategy.recommend_next_ban(allies, enemies, available, draft_step, side, weight_overrides)
