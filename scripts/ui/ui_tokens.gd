...
const DRAFT_ROLE_TOP_PX: int = 354
const DRAFT_ROLE_W_PX: int = 160
const DRAFT_ROLE_H_PX: int = 48
const DRAFT_CHAMPION_SCROLL_TOP_PX: int = 416
...
const DRAFT_RECOMMENDATION_HEIGHT_RATIO: float = 0.33
