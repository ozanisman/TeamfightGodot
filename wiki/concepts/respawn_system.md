...
On death: unit sets alive=false, records death time, increments death counter. Respawn timer counts down from respawn_time (default 10s, champion-specific). When timer expires, unit respawns at random Y position within [SPAWN_Y_MIN, SPAWN_Y_MAX] (3.0 to 7.0).
