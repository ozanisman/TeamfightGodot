...
Shield applied via shield opcode (max_hp_ratio or flat_amount). Shield stored in UnitState.shield field. Damage subtracts from shield before HP. Shield does not decay by default (SHIELD_DECAY_RATE = 0.1 but not actively used).
