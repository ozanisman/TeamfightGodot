...
struct PredictionConfig {
	...
	int draft_position = 0;  // 0 = not specified, 1-10 = global pick order (snake draft)
	double early_pick_base_weight = 0.7;  // for picks 1-3
	double late_pick_counter_weight = 0.4;  // for picks 7-10
};
